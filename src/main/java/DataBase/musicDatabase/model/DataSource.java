package DataBase.musicDatabase.model;
...
public class DataSource {
    ...
    public static final String QUERY_ARTIST_FOR_SONG_START = "SELECT " + TABLE_ARTISTS + "." + COLUMN_ARTIST_NAME + ", " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME + ", "
            ...
            + TABLE_ALBUMS + "." + COLUMN_ALBUM_ID + " INNER JOIN " + TABLE_ARTISTS + " ON " + TABLE_ALBUMS + "." + COLUMN_ALBUM_ARTIST + " = " + TABLE_ARTISTS +
    ...
    public static final String QUERY_VIEW_SONG_INFO = "SELECT " + COLUMN_ARTIST_NAME + ", " + COLUMN_SONG_ALBUM + "_name , " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = \"";

    public static final String QUERY_VIEW_SONG_INFO_PREP = "SELECT " + COLUMN_ARTIST_NAME + ", " + COLUMN_SONG_ALBUM + "_name, " + COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW +
            " WHERE " + COLUMN_SONG_TITLE + " = ?";

//    replacing "" with a placeholder - it makes statement to expect one value - it prevents sql injwction attacks
    ...
    public List<Artist> queryArtistsAndOrder(int sortOrder) {
...
//            sb.append(" COLLATE NOCASE ");
    ...
    public void querySourceMetadata() {
    ...
    public int getCountAndMin(String table) {
    ...
    public List<SongArtist> querySongInfoViewRefactoredForSafetyAndPerformance(String title){

        try {querySongInfoView.setString(1, title);
    ...
    private int insertArtist(String name) throws SQLException{
        ...
        if(results.next()){
            ...
            if(generatedKeys.next()){
                ...
                throw new SQLException("Couldn't get _id from artist");
            }
        }
    }
    ...
    private int insertAlbum(String name, int artistId) throws SQLException{
        ...
        if(results.next()){
            ...
            if(generatedKeys.next()){
                ...
                throw new SQLException("Couldn't get _id from album");
            }
        }
    }
    ...
    public void insertSong(String title, String artist, String album, int track) {
        ...
        try{
            ...
            try {
                ...
                System.out.println("Couldn't resetauto commit! " + e.getMessage());
            }
        }
